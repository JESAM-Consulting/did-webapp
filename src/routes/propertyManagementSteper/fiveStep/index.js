...
export default function FiveStep(props) {
  ...
  const addPropertyManage = async () => {
    setIsLoading(true);
    let data = {
      manageType: inputValue?.manageProperty,
      areaSize: inputValue?.areaSpace,
      currentUsage: inputValue?.useProperty,
    ...
    await ApiPost(`manage-property/add-manage-property`, data)
      .then((res) => {
      ...
      <div className="six-poroperty-step-content-alignment">
        ...
        <div className="checkbox-content-grid">
          ...
          <div>
            ...
            <a
              className="globally-error-message-style"
              style={{ color: "red" }}
            >
              {errors["informNews"]}
            </a>
